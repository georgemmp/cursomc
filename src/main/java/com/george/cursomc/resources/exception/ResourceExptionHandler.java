package com.george.cursomc.resources.exception;
...
import com.george.cursomc.services.exceptions.FileException;
...
public class ResourceExptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		ValidationError err = new ValidationError(HttpStatus.BAD_REQUEST.value(), "Erro de Valiação", System.currentTimeMillis());
